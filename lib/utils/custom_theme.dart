...
ThemeData customLightTheme(
  ...
  return ThemeData(
    ...
    highlightColor: customBlueColor.withOpacity(.5),
    primaryColor: Colors.white,
    indicatorColor: customBlueColor,
    floatingActionButtonTheme:
        FloatingActionButtonThemeData(backgroundColor: customBlueColor),
    unselectedWidgetColor: Colors.grey,
    brightness: Brightness.light,
    fontFamily: GoogleFonts.poppins().fontFamily,
    cardColor: Color.fromRGBO(250, 250, 250, 1),
    accentColor: customBlueColor,
    ...
    textTheme:
        Typography.material2018(platform: defaultTargetPlatform).white.copyWith(
              ...
              bodyText2: TextStyle(color: Color(0xffBEBEBE), fontSize: 14),
...
ThemeData customDarkTheme(
  ...
  return ThemeData(
    ...
    dividerTheme:
        DividerThemeData(color: Color.fromRGBO(113, 128, 150, 1), thickness: 1),
    inputDecorationTheme: InputDecorationTheme(
